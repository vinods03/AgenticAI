...
@CrewBase
class EnhancedAutomatedEtlPipeline():
    """EnhancedAutomatedEtlPipeline crew"""
    ...
    @task
    def quality_assurance_engineer_task(self) -> Task:
        return Task(
    ...
    @crew
    def crew(self) -> Crew:
        """Creates the EnhancedAutomatedEtlPipeline crew"""
